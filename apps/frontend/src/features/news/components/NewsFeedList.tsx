            ...
            >
              ...
              <div className="min-w-0 pr-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group flex items-start gap-1 text-xs font-bold text-slate-900 hover:text-blue-600 transition line-clamp-2"
                >
                  <span>{item.title}</span>
                  <ExternalLink className="size-3 shrink-0 opacity-0 group-hover:opacity-100 transition text-blue-600 mt-0.5" />
                </a>
