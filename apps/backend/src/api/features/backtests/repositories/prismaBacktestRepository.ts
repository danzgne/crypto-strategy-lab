...
export class PrismaBacktestRepository implements BacktestRepository {
    ...
    return this.prisma.$transaction(async (transaction) => {
      ...
      const experiment = await transaction.experiment.create({
        data: {
          ...
          ownerId,
          pair: input.pair,
          simulationRulesVersion: input.simulationRulesVersion,
          slippage: input.slippage,
          startTime: BigInt(input.startTime),
          strategyImplementationVersion: input.strategyImplementationVersion,
  ...
  public async findResource(
    ...
    return {
      ...
      generationOrdinal: experiment.generationOrdinal,
      generatorAlgorithm: experiment.generatorAlgorithm,
      generatorSeed: experiment.generatorSeed,
      generatorVersion: experiment.generatorVersion,
      ...
      status,
      strategyId: experiment.strategyVersion.strategyDefinition.type,
      strategyImplementationVersion: experiment.strategyImplementationVersion,
