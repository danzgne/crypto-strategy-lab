...
describe('SRStrategy', () => {
  ...
  it('emits BUY when current close is near a tracked support pivot', () => {
    const strategy = new SRStrategy({ n: 2, levelsTracked: 3, tolerance: 0.05 });
    ...
    const closes = [
      ...padding,
      100, 95, 90, 95, 100, // Pivot 1: 90
      110, 105, 100, 105, 110, // Pivot 2: 100
      120, 115, 110, 115, 120, // Pivot 3: 110
      110 // Current close
    ];
